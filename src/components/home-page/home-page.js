...
const Homepage = () => {
  return (
        <Router>
            <Navbar bg="light">
                <Container fluid>
                        <img src="/Asset/crud.png" alt="crud" style={{height:"30px", width:"40px"}}/>
                    ...
                    <Nav className="d-flex">
                        <Nav.Link to="#home" style={{color:"red"}}>SIGN IN</Nav.Link>
                        <Nav.Link to="#link" style={{backgroundColor:"red"}}>SIGN UP NOW</Nav.Link>
                    </Nav>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
