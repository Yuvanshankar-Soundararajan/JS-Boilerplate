          ...
          <form>
            <div>
              ...
              <div>
                ...
                <input
                  className="industry1"
                  placeholder="select on industry type"
                ></input>
                {/* </div> */}
              </div>
            </div>
            ...
            <div className="add">
              <h1>
                Organisation Address<span style={{ color: "red" }}>*</span>
              </h1>
              This will be considered as the address of your primary work
              location.<br></br>
              <input className="address" placeholder="Address Line1"></input>
              <br></br>
              <input className="address" placeholder="Address Line2"></input>
              <br></br>
              <input className="address" placeholder="City"></input>
              <input className="address" placeholder="Select a state"></input>
              <input className="address" placeholder="PIN Code"></input>
              <br></br>
              Note:If you have multiple work locations,you can add them later in
            ...
            <div>
              ...
              <br />
              <input type="checkbox" /> Yes we've already run payroll this year.
              <br />
              <input type="checkbox" /> No,we'll run out first payroll here with
              Zoho.
            </div>
            <br />
